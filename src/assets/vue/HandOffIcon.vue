...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-hand-off" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" :stroke="colour" fill="none" stroke-linecap="round" stroke-linejoin="round">
