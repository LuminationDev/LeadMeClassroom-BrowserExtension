...
<template>
  <div class="flex flex-col w-full h-full" @click="$emit('selectLesson', lessonPlan)">
    <div class="mx-4 bg-white rounded-md">
      <img v-if="lessonPlan && lessonPlan.lessonParts.length > 0"
           class="w-full h-40 object-cover rounded-t-md" alt="header image for lesson" :src="lessonPlan.lessonParts[0].imageUrl" />
      <div class="p-4">
      ...
      <div class="flex flex-row justify-end bg-purple-500 h-8">
